...
def build_policy_brief():
    ...
    kpi_matrix = [
        [
            ...
            Paragraph(f"<b>₹{sec['total_budget_cr']:,.1f} Cr</b><br/><font size=5 color='#64748B'>Hill-Adjusted Outlay</font>", cell_bold),
            Paragraph(f"<b>314 Blocks</b><br/><font size=5 color='#64748B'>30 Districts Analyzed</font>", cell_bold),
            Paragraph(f"<b>{econ.get('benefit_cost_ratio_roi', 1.8)}x GSDP ROI</b><br/><font size=5 color='#64748B'>₹{econ.get('net_present_value_gsdp_contribution_cr', 10796):,.0f} Cr Value</font>", cell_bold),
    ...
    fleet_table = [
        [
            ...
            Paragraph(f"<b>{sec['fleet_minibuses']:,} Mini-Buses (24-Seater)</b><br/><font size=4.8 color='#64748B'>@ ₹4.80L/yr Opex</font>", cell_bold),
            Paragraph(f"<b>{sec['fleet_feeder_vans']:,} Feeder Vans (12-Seater)</b><br/><font size=4.8 color='#64748B'>@ ₹3.00L/yr Opex</font>", cell_bold),
            Paragraph(f"<b>₹{sec['annual_transit_opex_cr']:.1f} Cr Annual Opex</b><br/><font size=4.8 color='#64748B'>Fuel, repairs & chaperones</font>", cell_bold),
    ...
    roi_and_recs = (
        f"<b>Audited Economic ROI:</b> Retaining 184,000 secondary students generates <b>₹{econ.get('net_present_value_gsdp_contribution_cr', 10796):,.1f} Cr lifetime GSDP value</b> "
        f"(0.75x informal labor discount), delivering a <b>{econ.get('benefit_cost_ratio_roi', 1.8)}x Benefit-Cost Ratio</b> on ₹{sec['total_budget_cr']:,.1f} Cr capital outlay.<br/>"
