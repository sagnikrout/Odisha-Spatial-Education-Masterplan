"""
Odisha Spatial Education Masterplan: 2-Page Standalone Executive Policy Brief Generator
...
class BriefCanvas(canvas.Canvas):
    ...
    def draw_brief_decorations(self, total_pages):
        ...
        self.drawRightString(595 - 36, 842 - 28, "EXECUTIVE POLICY BRIEF (2026–2031)")
        ...
        self.drawString(36, 22, "Confidential — Operations Research & GIS Decision-Support Brief")
...
def build_policy_brief():
    ...
    story.append(Paragraph("A Data-Driven GIS & Operations Research Strategy for Universal Secondary Access Across 314 CD Blocks", subtitle_style))
    ...
    kpi_matrix = [
        [
            ...
            Paragraph(f"<b>₹{sec['total_budget_cr']:,.1f} Cr</b><br/><font size=6 color='#64748B'>Secondary Outlay</font>", cell_bold),
            Paragraph(f"<b>314 Blocks</b><br/><font size=6 color='#64748B'>30 Districts Analyzed</font>", cell_bold),
            Paragraph(f"<b>2.81x GSDP ROI</b><br/><font size=6 color='#64748B'>₹14,395 Cr Value</font>", cell_bold),
            Paragraph(f"<b>9,144 Posts</b><br/><font size=6 color='#64748B'>Subject Teachers (1:30)</font>", cell_bold)
        ]
    ]
    ...
    story.append(Paragraph("1. The Core Policy Challenge: Grade 8 → 9 Accessibility Cliff", sec_head))
    p1 = (
    ...
    story.append(Paragraph("2. Mathematical Operations Research & Terrain Friction Engine", sec_head))
    p2 = (
        "Replacing conventional blanket school construction with <b>PuLP Mixed-Integer Linear Programming (MILP / MCLP)</b>, the algorithm maximizes "
        ...
        "reaching 1.8x to 2.4x in hill corridors). Interventions are allocated across three optimized pillars: "
        "<b>(1) Upper Primary Upgrades (₹85L)</b>, <b>(2) Greenfield Campuses (₹244L)</b>, and <b>(3) Student Transit & Residential Hostel Hubs (₹30L)</b>."
    )
    story.append(Paragraph(p2, body_text))

    story.append(Paragraph("3. Statewide Multi-Tier Investment & Physical Targets", sec_head))
    st_table = [
        [
    ...
    # =========================================================================
    # PAGE 2: 314 BLOCKS, GENDER EQUITY, FLEET SIZING & 5-YEAR ROADMAP
    # =========================================================================
    ...
    story.append(Paragraph("5. Social Equity, Transit Fleet Sizing & Staff Recruitment", sec_head))
    fleet_table = [
        [
            Paragraph("<b>588 Dedicated Girls' Hostels</b><br/><font size=5.5 color='#64748B'>Guarantees female retention</font>", cell_bold),
            Paragraph("<b>1,027 Mini-Buses (24-Seater)</b><br/><font size=5.5 color='#64748B'>Paved trunk routes</font>", cell_bold),
            Paragraph("<b>603 Feeder Vans (12-Seater)</b><br/><font size=5.5 color='#64748B'>Rugged 4WD trails</font>", cell_bold),
            Paragraph("<b>₹43.6 Cr Annual Opex</b><br/><font size=5.5 color='#64748B'>Fuel, repairs & drivers</font>", cell_bold),
            Paragraph("<b>9,144 Subject Teachers</b><br/><font size=5.5 color='#64748B'>Math/Science/Eng (1:30 PTR)</font>", cell_bold)
        ]
    ]
    ...
    story.append(Paragraph("6. 5-Year Phased Capital Rollout & Socio-Economic ROI", sec_head))
    p_rollout = [
        ...
        [Paragraph("<b>Phase 1 (Y1–Y2)</b>", cell_bold), Paragraph("High Vulnerability Tribal Corridors (9 Dists)", cell_text), Paragraph("₹2,305 Cr (45%)", cell_bold), Paragraph("981", cell_text), Paragraph("537", cell_text), Paragraph("644", cell_text), Paragraph("+16.5%", cell_bold)],
        [Paragraph("<b>Phase 2 (Y3–Y4)</b>", cell_bold), Paragraph("Mineral Belts & Western Plateaus (11 Dists)", cell_text), Paragraph("₹1,793 Cr (35%)", cell_bold), Paragraph("763", cell_text), Paragraph("418", cell_text), Paragraph("351", cell_text), Paragraph("+11.2%", cell_bold)],
        [Paragraph("<b>Phase 3 (Y5)</b>", cell_bold), Paragraph("Coastal Deltas & Cyclone Retrofits (10 Dists)", cell_text), Paragraph("₹1,024 Cr (20%)", cell_bold), Paragraph("436", cell_text), Paragraph("239", cell_text), Paragraph("175", cell_text), Paragraph("+4.8%", cell_bold)]
    ]
    ...
    roi_text = (
        "<b>Economic Return on Investment (ROI):</b> Preventing secondary dropouts yields an estimated <b>184,000 retained graduates</b> over 5 years. "
        "With an annual secondary wage premium of ₹1.70 Lakhs/student, the <b>Net Present Value (NPV) lifetime GSDP contribution is ₹14,395.1 Crores</b>, "
        "yielding a <b>2.81x Benefit-Cost Ratio</b> on the ₹5,122.1 Cr capital investment."
    )
    ...
    recs = (
        "1. <b>Inter-Departmental Steering:</b> Establish joint coordination between S&ME, ST&SC Development, and Panchayati Raj for synchronized road and power connectivity.<br/>"
        "2. <b>Staff Recruitment Fast-Track:</b> Sanction 9,144 Subject Teacher posts (Math, Science, English) aligned with Phase 1 school commissioning.<br/>"
        "3. <b>Community Transit Operations:</b> Partner with Mission Shakti Women SHGs for bus management, female chaperones, and student route scheduling.<br/>"
        "4. <b>ORSAC & UDISE+ GIS Integration:</b> Deploy a real-time satellite GIS portal for geo-fenced milestone auditing across all 314 blocks."
    )
