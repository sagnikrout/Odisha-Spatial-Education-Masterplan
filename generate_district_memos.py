...
def generate_all_district_memos():
    print(f"Generating 30 District Action Memos in {MEMOS_DIR}...")
    ...
    for d in data["districts"]:
        ...
        # =====================================================================
        # PAGE 1: DISTRICT OVERVIEW & GIS MAP
        # =====================================================================
        ...
        # =====================================================================
        # PAGE 2: GRANULAR BLOCK-BY-BLOCK PRIORITY TABLE & ACTION ROADMAP
        # =====================================================================
    ...
    print(f"Successfully generated all 30 District Action Memos in {MEMOS_DIR}.")


if __name__ == "__main__":
    generate_all_district_memos()
